...
DO $$ BEGIN
    CREATE TYPE user_role AS ENUM ('SUPERADMIN', 'ADMIN', 'USER', 'OWNER', 'FINANCE_ADMIN', 'MEAL_MANAGER', 'HOSTEL_MANAGER', 'AUDITOR', 'SUPPORT_ADMIN', 'READONLY_ADMIN');
...
DO $$ BEGIN
    CREATE TYPE transaction_type AS ENUM ('CREDIT', 'DEBIT', 'ADJUSTMENT', 'REFUND', 'ADMIN_TOPUP', 'MEAL_DEDUCTION', 'MONTHLY_CHARGE', 'PENALTY', 'DISCOUNT', 'RECHARGE', 'CASH_PAID');
EXCEPTION WHEN duplicate_object THEN null; END $$;
...
CREATE TABLE IF NOT EXISTS users (
    ...
    is_indefinitely_paused BOOLEAN NOT NULL DEFAULT FALSE,
